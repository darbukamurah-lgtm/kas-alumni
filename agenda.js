...
function renderFeatured(){
  ...
  document.getElementById("featDate").innerHTML = `<i class="fa-regular fa-calendar"></i> ${tgl.toLocaleDateString("id-ID")}`;
  document.getElementById("featTime").innerHTML = `<i class="fa-regular fa-clock"></i> ${a.jam}`;
}
